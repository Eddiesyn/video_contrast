...
from utils import ContrastiveSampler
...
def make_dataset(root_path, annotation_path, subset, n_samples_for_each_video,
    ...
    dataset = []
    index_lookup = {}
    for i in range(len(idx_to_class.keys())):
        index_lookup[i] = []
    ...
    for i in range(len(video_names)):
        ...
        if len(annotations) != 0:
            ...
            index_lookup[sample['label']].append(i)
        else:
            sample['label'] = -1
    ...
    return dataset, idx_to_class, index_lookup
...
class UCF101(data.Dataset):
    ...
    def __init__(self,
        ...
        self.data, self.class_names, self.lookup = make_dataset(
