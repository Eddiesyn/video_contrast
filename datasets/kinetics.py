        ...
        if self.subset == 'validation':
            ...
            if self.spatial_transform is not None:
                ...
                for frames in total_frames:
                    clip = self.loader(path, frames, self.sample_duration)
                    self.spatial_transform.randomize_parameters()
                    clip = [self.spatial_transform(img) for img in clip]
                    clip = torch.stack(clip, 0).permute(1, 0, 2, 3)
                    clips.append(clip)
...
#            self.spatial_transform.randomize_parameters()
#            clip3 = [self.spatial_transform(img) for img in clip3]
#            self.spatial_transform.randomize_parameters()
#            clip4 = [self.spatial_transform(img) for img in clip4]
#            self.spatial_transform.randomize_parameters()
#            clip5 = [self.spatial_transform(img) for img in clip5]
#            self.spatial_transform.randomize_parameters()
#            clip6 = [self.spatial_transform(img) for img in clip6]
#        clip1 = torch.stack(clip1, 0).permute(1, 0, 2, 3)
#        clip2 = torch.stack(clip2, 0).permute(1, 0, 2, 3)
#        clip3 = torch.stack(clip3, 0).permute(1, 0, 2, 3)
#        clip4 = torch.stack(clip4, 0).permute(1, 0, 2, 3)
#        clip5 = torch.stack(clip5, 0).permute(1, 0, 2, 3)
#        clip6 = torch.stack(clip6, 0).permute(1, 0, 2, 3)
